...
#   2. Ensure your GitHub repo (suryavamsi6/booklore) is public (required for Libre plan)
#
# Usage:
...
PROJECT_WEB="https://github.com/suryavamsi6/booklore"

REPO_URL="https://github.com/suryavamsi6/booklore.git"
REPO_BRANCH="develop"
